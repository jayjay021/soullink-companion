...
INSERT INTO "new_Pokemon" ("id", "image", "inBox", "isDead", "isLinked", "name", "playerId", "position", "route", "sessionId") SELECT "id", "image", "inBox", "isDead", "isLinked", "name", "playerId", "position", "route", "sessionId" FROM "Pokemon";
DROP TABLE "Pokemon";
